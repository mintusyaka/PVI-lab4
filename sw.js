...
const assetUrls = [
    '/PII/index.html',
    '/PII/scripts/script.js',
    '/PII/scripts/modal-add-edit.js',
    '/PII/handle-data.php',
    '/PII/styles/modal-style.css',
    '/PII/styles/notifications-dropdown.css',
    '/PII/styles/profile-dropdown.css',
    '/PII/styles/smartphone-style.css' 
]
